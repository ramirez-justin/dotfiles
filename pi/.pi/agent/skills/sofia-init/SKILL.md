...
2. Pre-load context: read `~/.pi/agent/AGENTS.md`, the existing files under `$SOFIA_VAULT/_agent/`, and any earlier conversation context the user has shared in this session.
